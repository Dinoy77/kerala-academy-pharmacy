...
export const blogs = [
  ...
  },
  {
    slug: "blog13",
    image: IMG + "b13.webp",
    title: "National Deworming Day — 10th February",
    tag: "Public Health",
    desc: "The Ministry of Health and Family Welfare created the National Deworming Day. Every year on February 10, the nation's children are encouraged to be worm-free",
  ...
  },
  {
    slug: "blog14",
    image: IMG + "b14.png",
    title: "International Day of Zero Tolerance for Female Genital Mutilation — 6th February",
    tag: "Human Rights",
    desc: "As part of the UN's efforts to end female genital mutilation, the organization sponsors the International Day of Zero Tolerance for Female Genital Mutilation every",
  ...
  },
  {
    slug: "blog15",
    image: IMG + "b15.jpg",
    title: "World Cancer Day — 4th February",
    tag: "Awareness",
    desc: "On February 4, the world observes World Cancer Day, a day set aside to promote cancer awareness and the prevention, identification, and treatment of the",
  ...
  },
  {
    slug: "blog16",
    image: IMG + "b16.jpg",
    title: "Is B.Pharm a Good Career?",
    tag: "Career",
    desc: "The field of pharmacy education has come a long way in recent years. In addition, the covid-19 ruthless times of today have demonstrated it more",
    date: "January 3, 2023",
    content: [
  ...
  },
  {
    slug: "blog17",
    image: IMG + "b18.jpg",
    title: "Opportunities in Pharmacy Industry in the Post-Covid Era",
    tag: "Insights",
    desc: "The pharmacy industry's need has been demonstrated to be of the utmost importance in the wake of Covid-19. The need of the hour is to",
    date: "January 3, 2023",
    content: [
  ...
  },
  {
    slug: "blog18",
    image: IMG + "b19.png",
    title: "International Volunteer Day for Economic and Social Development — 5th December",
    tag: "Community",
    desc: "Every year on December 5, the world observes the International Volunteer Day for Economic and Social Development. International Volunteer Day, or IVD for short, is",
  ...
  },
  {
    slug: "blog19",
    image: IMG + "b20.jpg",
    title: "World Computer Literacy Day — 2nd December",
    tag: "Digital",
    desc: "We observe World Computer Literacy Day on December 2. N.I.I.T started the holiday in 2001 as a way to celebrate the company's 20th anniversary and",
  ...
  },
  {
    slug: "blog20",
    image: IMG + "b21.webp",
    title: "World AIDS Day — December 1",
    tag: "Awareness",
    desc: "World AIDS Day has been observed on December 1 every year since 1988 to honour those who have lost their lives to the disease and",
  ...
  /* -------------------------------------------------------------
     ACADEMIC & PHARMACY SUBJECT BLOGS (AI IMAGES)
     ------------------------------------------------------------- */
  {
    slug: "blogh1",
    image: "/assets/images/blog_ai_1.jpg",
    title: "Study About Pharmaceutical Chemistry",
    tag: "Chemistry",
    desc: "The drug discovery and development is the main AIM. The drug discovery and development process is designed to ensure that only those pharmaceutical products that are both safe and effective are brought to market.",
    date: "May 10, 2021",
    content: [
  ...
  {
    slug: "blogh2",
    image: "/assets/images/blog_ai_2.jpg",
    title: "Study About Pharma Practices",
    tag: "Practice",
    desc: "Pharmacy Practice is an interesting branch of pharmacy focused on patient-centred activities. Pharmacy Practice consists of subjects like Pharmacotherapeutics, Clinical Pharmacy, Hospital Pharmacy etc. and",
    date: "May 15, 2021",
    content: [
  ...
  {
    slug: "blogh3",
    image: "/assets/images/blog_ai_3.jpg",
    title: "Study About Pharmaceutics",
    tag: "Pharmaceutics",
    desc: "Pharmaceutics is the discipline of Pharmacy that manages the way toward turning a new chemical entity (NCE) or old drugs into a medicine to be utilized securely and adequately by patients.",
    date: "May 22, 2021",
    content: [
  ...
  {
    slug: "blogh4",
    image: "/assets/images/blog_ai_4.jpg",
    title: "Study About Pharmacognosy and Phytochemistry",
    tag: "Research",
    desc: "Pharmacognosy deals with the study of Natural Drugs having Therapeutic Value. Pharmacognosy and Phytochemistry is a subject of mere importance since ancient time as it provides natural remedies for diseases with no/less side effects.",
    date: "May 23, 2021",
    content: [
  ...
  {
    slug: "blogh5",
    image: "/assets/images/blog_ai_5.jpg",
    title: "Study About Pharmacology",
    tag: "Pharmacology",
    desc: "Pharmacology is the scientific discipline that studies drugs and their mechanisms by which they alter biological systems. The research areas focused in the Department are Toxicological Studies",
    date: "May 28, 2021",
    content: [
  ...
  {
    slug: "blogh6",
    image: "/assets/images/blog_ai_6.jpg",
    title: "Pharmacopoeia",
    tag: "Guide",
    desc: "Pharmacopoeia is an authenticated compilation, describing the standards of Strength and Purity of Drugs, Medicinal Preparations, Chemicals etc.",
    date: "May 30, 2021",
    content: [
  ...
  {
    slug: "blogh7",
    image: "/assets/images/blog_ai_7.jpg",
    title: "How to Become a Pharmacist",
    tag: "Career",
    desc: "In India, if you want to become a Pharmacist you need to study D-Pharm (Diploma in Pharmacy). The eligibility for admission to D-Pharm is a pass in 12th STD with",
  ...
  {
    slug: "blogh8",
    image: "/assets/images/blog_ai_8.jpg",
    title: "Why Pharmacy is a Good Career?",
    tag: "Insights",
    desc: "The pharmaceutical industry is not an exception when it comes to how successful its managers are. A pharmaceutical company's success depends on having skilled and creative managers. Some people are born with leadership skills, while others learn to develop them over time.",
    date: "January 3, 2023",
    content: [
